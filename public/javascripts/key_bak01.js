...
$(document).ready(function(){
    var $notify_zone=$('#save-record-zone');
    ...
    function create_ui_record(d){
        ...
        if($transaction_type.val()=="RIN_RSD" || $transaction_type.val()=="UPC_RSD"){
            var description=$('<input id="Description" class="can-ocr" append="append" style="text-transform:uppercase">').val(d.Description);
    ...
    function add_rec_notify_eff(){
        ...
        $notify_zone.stop().animate({backgroundColor: "rgba(0,0,0,1)"}, 300, function() {
